...
<div class="card mb-4">
    <div class="card-header">
        ...
        <span class="ml-auto">
        <a href="{{route('post.edit', ['post'=>$post->id])}}"><button class="btn btn-primary">編集</button></a>
        </span>
        <span class="ml-2">
    ...
    <div class="p-3">
        ...
        @foreach($post->comments as $comment)
           <div class="card">
            ...
            @endforeach
           <a href="{{ route('comments.create', ['post_id'=>$post->id]) }}" class="btn btn-primary">≫コメントを書く</a>
    </div>
